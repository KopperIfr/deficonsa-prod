    ...
    return(
        <motion.div
            ...
            className="w-full h-full flex justify-center items-center xl:w-1/3 xl:border-r-[.1rem] xl:border-[#e2cb8b] services-bp:mb-0 xl:min-h-[7.5rem] xl:pr-[1rem] services-bp:pb-[1rem] 2xl:pr-[2.5rem]">
                <h2 className="text-white text-[1.6rem] font-semibold sm:mb-[1.5rem] nav-lg:text-[2rem] xl:text-[1.8rem] services-bp:mb-0 2xl:text-[2rem] 2xl:min-h-[9rem] 2xl:flex 2xl:gap-3 2xl:items-end 2xl:pb-5">
