...
export default function BgHome() {
    return(
        <div className="absolute w-full top-0 left-0 flex flex-col -z-10">
            <div className="bg-[#141413] tiny-460:h-[7rem] nav-lg:h-[10rem] 3xl:h-[12rem] relative w-full overflow-hidden transition-all duration-300"> 
                <Circle />
            </div>
            <div className="h-[47rem] tiny-460:h-[30rem] md:h-[35rem] nav-lg:h-[40rem] w-full relative overflow-hidden 3xl:h-[53rem] 4k:h-[70rem]">
            ...
            <div className="bg-[#1b1a18] h-[144.1rem] tiny:h-[149rem] sm:h-[154rem] md:h-[120rem] nav-lg:h-[125rem] bg-home-1104:h-[95rem] xl:h-[73.4rem] 2xl:h-[86.4rem] 3xl:h-[110rem] 4k:h-[115rem] relative w-full overflow-hidden"> 
